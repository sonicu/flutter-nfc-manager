...
class HostApiPigeon {
  ...
  Future<List<Uint8List>> iso15693ExtendedReadMultipleBlocks({required String handle, required List<Iso15693RequestFlagPigeon> requestFlags, required int blockNumber, required int numberOfBlocks, }) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.nfc_manager.HostApiPigeon.iso15693ExtendedReadMultipleBlocks$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
